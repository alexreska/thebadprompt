    ...
    return Column(
        children: [
          ...
          const Text(
            ...
            style: TextStyle(
              color: TbpPalette.darkViolet, // Requested Violet
              fontSize: 14,
    ...
    Widget build(BuildContext context) {
      return Container(
        ...
        decoration: BoxDecoration(
          color: TbpPalette.darkViolet.withValues(alpha: 0.05), // Light Violet BG
          borderRadius: BorderRadius.circular(30),
          border: Border.all(color: TbpPalette.darkViolet.withValues(alpha: 0.5)), // Violet Border
        ),
        child: Column(
          children: [
            Text(
              ...
              style: const TextStyle(
                color: TbpPalette.darkViolet, // Violet Text
